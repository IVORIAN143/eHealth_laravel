...
<head>
    ...
    <link rel="shortcut icon" href="public/assets/images/isu-logo.svg ">
        ...
        <div id="app-sidepanel" class="app-sidepanel">
            ...
            <div class="sidepanel-inner d-flex flex-column">
                ...
                <div class="app-branding">
                    <a class="app-logo" href="{{route('home')}}"><img class="logo-icon me-2" src=" public/assets/images/isu-logo.svg" alt="logo"><span class="logo-text">eHealthmate</span></a>
