                ...
                <form action="{{ route('storestudent') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input value="{{ old('parentName') }}" type="text" name="parentName" class="form-control">
                            @error('parentName')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input value="{{ old('parentNumber') }}" type="text" name="parentNumber" class="form-control">
                            @error('parentNumber')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input value="{{ old('height') }}" type="text" name="height" class="form-control">
                            @error('height')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input value="{{ old('weight') }}" type="text" name="weight" class="form-control">
                            @error('weight')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
