            ...
            <form action="{{ route('storestudent') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group" id="student-id-container">
                        ...
                        <input id="student_id" value="{{ old('student_id') }}" type="text" name="student_id" class="form-control">
                        @error('student_id')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="form-group">
                        ...
                        <input id="contact" value="{{ old('contact') }}" type="text" name="contact" class="form-control">
                        @error('contact')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{ old('middlename') }}" type="text" name="middlename" class="form-control">
                        @error('middlename')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{ old('dateOfBirth') }}" type="date" name="dateOfBirth" class="form-control">
                        @error('dateOfBirth')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{ old('homeAddress') }}" type="text" name="homeAddress" class="form-control">
                        @error('homeAddress')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{ old('parentName') }}" type="text" name="parentName" class="form-control" placeholder="Whole name">
                        @error('parentName')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{ old('parentAddress') }}" type="text" name="parentAddress" class="form-control">
                        @error('parentAddress')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input id="parentNumber" value="{{ old('parentNumber') }}" type="text" name="parentNumber" class="form-control">
                        @error('parentNumber')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="form-group">
                        ...
                        <input id="height" value="{{ old('height') }}" type="text" name="height" class="form-control">
                        @error('height')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input id="weight" value="{{ old('weight') }}" type="text" name="weight" class="form-control">
                        @error('weight')
                        <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $("#parentNumber").inputmask("(999) 999-9999");
        ...
        $("#height").inputmask("999 cm"); // Apply specific mask to the student_id input field
        $("#weight").inputmask("999 kg"); // Apply specific mask to the student_id input field
    });
